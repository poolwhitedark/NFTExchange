...
//	    public static final Version MIN_VERSION = Version.parse("0.4.11");
		public static final String MIN_VERSION = "0.4.11";
	    ...
	    private static final int DEFAULT_CONNECT_TIMEOUT_MILLIS = 180_000;
	    private static final int DEFAULT_READ_TIMEOUT_MILLIS = 180_000;
...
//	            if (detected.isBefore(MIN_VERSION))
				String version_my=version();
				if(version_my.compareTo(MIN_VERSION)==-2){
